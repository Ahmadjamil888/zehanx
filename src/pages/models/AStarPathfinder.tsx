...
const AStarPathfinder: React.FC = () => {
  return (
    <Layout>
      <div className="min-h-screen py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-white mb-6">A* Path Finder</h1>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Intelligent pathfinding algorithm implementation for robotics, 
              game AI, and navigation systems with optimal route calculation.
            </p>
          </div>
